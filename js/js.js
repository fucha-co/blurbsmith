...
jQuery(document).ready(function($) {
	...
	function initHomeSection() {
		...
		if( $('body').hasClass('slide-background') ) {
			...
			$("body").backstretch([
				"http://bluminethemes.com/preview/html/luna/demo/images/bg3.jpg",
				"http://bluminethemes.com/preview/html/luna/demo/images/bg5.jpg",
				"http://bluminethemes.com/preview/html/luna/demo/images/bg9.jpg",
	...
	function initErrorSection() {
		...
		if( $('#error_404').hasClass('slide-background') ) {
			...
			$("#error_404").backstretch([
				"http://bluminethemes.com/preview/html/luna/demo/images/bg1.jpg",
				"http://bluminethemes.com/preview/html/luna/demo/images/bg2.jpg",
			], {duration: 2600, fade: 1000});
...
$(window).load(function(){
	...
	var contentString = '<div id="content">'+
		'<div id="siteNotice">'+
		'</div>'+
		'<h3 id="firstHeading" class="firstHeading">Luna</h3>'+
		'<div id="bodyContent">'+
