...
// Compile Sass For Style Guide Components (styles/components)
...
gulp.task('styles:scss', function () {
  return gulp.src(['styles/**/*.scss', '!styles/components/components.scss'])
    .pipe($.rubySass({
      style: 'expanded',
      precision: 10,
      loadPath: ['styles']
...
gulp.task('html', function () {
  return gulp.src('**/*.html')
    ...
    .pipe($.if('*.css', $.uncss({ html: ['index.html','styleguide/index.html'] })))
    .pipe($.useref.restore())
    .pipe($.useref())
...
gulp.task('serve', function () {
  ...
  gulp.watch(['styles/**/*.{css,scss}'], ['styles']);
